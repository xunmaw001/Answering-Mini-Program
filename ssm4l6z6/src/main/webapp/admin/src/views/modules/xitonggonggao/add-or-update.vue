<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告名称" prop="gonggaomingcheng">
          <el-input v-model="ruleForm.gonggaomingcheng" 
              placeholder="公告名称" clearable  :readonly="ro.gonggaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告名称" prop="gonggaomingcheng">
              <el-input v-model="ruleForm.gonggaomingcheng" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fabuneirong = this.ruleForm.fabuneirong.replace(reg,'../../../ssm4l6z6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
